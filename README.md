...
│   ├── pipeline_generator.py # Pipeline execution engine
│   ├── sources/              # Data source connectors
│   ├── warehouse/            # DuckDB warehouse client
│   ├── metadata/             # Pipeline metadata management
│   ├── transforms/           # SQL transformation files
│   ├── data_quality/         # Data quality check implementations
